                ...
                <Card
                    style={
                        completion
                            ? {
                                  borderRadius: '10px',
                                  border: '1px solid rgb(99, 250, 91)',
                              }
                            : {
                                  borderRadius: '10px',
                    ...
                    <Collapse in={expanded} timeout="auto" unmountOnExit>
                        <CardContent>
                            <div className="center_everything">
                                <div className="title">Sale Details</div>
                                <div>
                                    <Popup
                                        trigger={
                                            <IconButton
...
SoldRectangle.propTypes = {

}

export default SoldRectangle
