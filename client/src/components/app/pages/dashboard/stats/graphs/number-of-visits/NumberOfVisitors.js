...
const NumberOfVisitors = ({
    ...
    // getTotalHitsChartWeek,
    // Redux State
    metrics: { numberOfVisitorsChartLoading, numberOfVisitorsChart },
}) => {
        ...
        <div className="charts flex_middle">
            <div className={'card-metrics'}>
                <div className="triple_grid">
                    <div></div>
                    <div className="title flex_middle">Number of Visitors</div>
                ...
                {numberOfVisitorsChartLoading ? (
                    ...
                    <>
                        {numberOfVisitorsChart.length > 0 ? (
                            <ResponsiveContainer
                                width="99%"
                                height={width < 768 ? 270 : '99%'}
                            >
                                <LineChart
                                    data={numberOfVisitorsChart}
                                    margin={{
                                        top: 20,
                                        right: 50,
                                        left: 0,
...
export default connect(mapStateToProps, mapStateToActions)(NumberOfVisitors)
